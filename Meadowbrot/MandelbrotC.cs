...
namespace Meadowbrot
{
    ...
    */
    ...
    // https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/mandelbrot-csharpcore-5.html
    ...
    class MandelbrotC
    {
        ...
        public static byte[][] Generate(int dimensions)
        {
            n = dimensions;
            ...
            sw.Stop();
            Console.WriteLine($"C# Compute {sw.ElapsedMilliseconds / 1000.0}s");
